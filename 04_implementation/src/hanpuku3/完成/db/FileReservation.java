...
public class FileReservation {
	public void getReservationdata(ReservationList rl) {
		File dir = new File("C:\\Users\\Administrator\\eclipse-workspace\\hanpuku3\\src\\db\\ReservationObject");
		...
		rl.downlodeReservationData(list_M);
	}
	
	public void setReservationdata(ReservationList rl) {
		...
		ArrayList<Reservation> list_M=new ArrayList<Reservation>();
		rl.updateReservationData(list_M);
		for(int i=0;i<list_M.size();i++) {
			String filePath = "C:\\Users\\Administrator\\eclipse-workspace\\hanpuku3\\src\\db\\ReservationObject";
