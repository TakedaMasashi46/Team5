...
public class FileMember {
	public void getMemberdata(MemberList memberList) {
		File dir = new File("C:\\Users\\Administrator\\eclipse-workspace\\hanpuku2\\src\\db\\MemberObject");
		...
		memberList.downlodeMemberData(list_M);
	}
	...
	public void setMemberdata(MemberList ml) {
		...
		for(int i=0;i<list_M.size();i++) {
			String filePath = "C:\\Users\\Administrator\\eclipse-workspace\\hanpuku2\\src\\db\\MemberObject";
